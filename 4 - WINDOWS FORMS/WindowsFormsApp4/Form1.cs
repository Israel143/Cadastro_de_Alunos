...
namespace WindowsFormsApp4
{
    ...
    {
        public static List<CadastroAlunos> testes = new List<CadastroAlunos>();
        ...
        private void SetupDataGridView()
        {
            ...
            dataGridView1.Columns[5].Name = "CPF";
        ...
        {
            var novo = new CadastroAlunos();
            novo.Nome = txtString.Text;
            novo.Cpf = textBox1.Text;
        ...
        private void AtualizarLista()
        {
            ...
            {
                dataGridView1.Rows.Add(new object[] { "Clique para Alterar", "Clique para Excluir", i.Id.ToString(), i.DataHora.ToString(), i.Nome, i.Cpf.ToString()});
            }
        }
